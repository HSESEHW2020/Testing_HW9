...
public class BasicSeleniumTest {
    ...
    public void testChrome() {
        ...
        final String pathToDriver = Paths.get("lib", "chromedriver").toAbsolutePath().toString();
    ...
    public void testFirefox() {
        ...
        final String pathToGeckoDriver = Paths.get("lib","geckodriver").toAbsolutePath().toString();
